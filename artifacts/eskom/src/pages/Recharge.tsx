...
// Local metadata for display: color, symbol, display label per NowPayments code
const CURRENCY_META: Record<string, { label: string; network: string; color: string; symbol: string; bg: string }> = {
  usdtbsc:    { label: "USDT",       network: "BNB Smart Chain (BEP20)", color: "#26A17B", symbol: "₮", bg: "rgba(38,161,123,0.18)" },
  usdtmatic:  { label: "USDT",       network: "Polygon (MATIC)",         color: "#8247E5", symbol: "₮", bg: "rgba(130,71,229,0.18)" },
  usdterc20:  { label: "USDT",       network: "Ethereum (ERC20)",        color: "#26A17B", symbol: "₮", bg: "rgba(38,161,123,0.18)" },
  usdttrc20:  { label: "USDT",       network: "TRON (TRC20)",            color: "#EF0027", symbol: "₮", bg: "rgba(239,0,39,0.18)" },
  ...
  matic:      { label: "MATIC",      network: "Polygon",                 color: "#8247E5", symbol: "⬡", bg: "rgba(130,71,229,0.18)" },
  avax:       { label: "AVAX",       network: "Avalanche",               color: "#E84142", symbol: "▲", bg: "rgba(232,65,66,0.18)" },
  usdteosio:  { label: "USDT",       network: "EOS",                     color: "#14191E", symbol: "₮", bg: "rgba(20,25,30,0.3)" },
};

const DEFAULT_META = { label: "", network: "", color: "#aaaaaa", symbol: "◉", bg: "rgba(170,170,170,0.18)" };
