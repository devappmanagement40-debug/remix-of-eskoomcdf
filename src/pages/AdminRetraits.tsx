                  ...
                  <div className="px-4 pt-4 pb-3">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        ...
                        <div className="flex items-center gap-1.5 mt-0.5">
                          ...
                          <span className="text-sm font-semibold text-success">Net : {r.net_amount.toLocaleString("fr-FR")} XAF</span>
                    ...
                    <div className="grid grid-cols-2 gap-x-4 gap-y-2 mt-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-semibold text-foreground">{r.amount.toLocaleString("fr-FR")} XAF</p>
                      </div>
                      <div>
                        <p className="text-[10px] text-muted-foreground">Solde actuel :</p>
                        <p className="text-xs font-semibold text-foreground">{profile ? `${(profile.balance || 0).toLocaleString("fr-FR")} XAF` : "—"}</p>
                      </div>
                      <div>
